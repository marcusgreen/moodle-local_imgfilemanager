 ...
 * @since     Moodle 2.0
 */
class local_imgfilemanager_renderer extends plugin_renderer_base {
    ...
    protected function fm_print_generallayout($fm) {
        ...
        return $this->render_from_template('local_imgfilemanager/filemanager_page_generallayout', $context);
    }
